...
(function () {
    ...
    //Check if this is a ServiceNow instance for ServiceNow-specific features
    var msg = { 
        "event" : "checkisservicenowinstance",
        "origin" : location.origin 
    }
    chrome.runtime.sendMessage(msg, isServiceNow => {
        // Always inject basic scripts for core functionality
        ...
        // Only inject ServiceNow-specific scripts on ServiceNow instances
        // if (isServiceNow) {
